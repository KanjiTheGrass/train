//=============================================================================
// SVキャラのモーションを拡張するプラグイン fix 1462 line
// FTKR_ExSvMotion.js
// プラグインNo : 24
// 作成者     : フトコロ
// 作成日     : 2017/04/19
...
const __KNS_performRecovery = Game_Enemy.prototype.performRecovery;
Game_Enemy.prototype.performRecovery = function() {
    __KNS_performRecovery.apply(this, arguments);
    this.requestMotion(FTKR.ESM.motion.basic.recovery);
};

//書き換え
const __KNS_performAction = Game_Enemy.prototype.performAction;
Game_Enemy.prototype.performAction = function(action) {
    __KNS_performAction.apply(this, arguments);
    if (action.isAttack()) {
        this.performAttack();
    } else if (action.isGuard()) {
        this.requestMotion('refresh');
...
Game_Enemy.prototype.esmMotion = function(item, motion) {
    return readObjectMeta(item, ['ESM モーション', 'ESM MOTION']) || motion;
}
